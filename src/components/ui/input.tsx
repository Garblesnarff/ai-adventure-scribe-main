  ...
  return (
    <input
      ...
      className={cn(
        ...
        variant === 'fantasy'
          ? 'h-12 border-2 bg-white/80 backdrop-blur-sm border-amber-200 hover:border-amber-300 focus:border-infinite-gold focus:ring-infinite-gold/30 transition-all duration-200 ease-in-out'
