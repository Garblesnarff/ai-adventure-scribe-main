  ...
  "inline-flex items-center justify-center border font-semibold transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-electricCyan focus-visible:ring-offset-2 relative hover:scale-105",
  {
    variants: {
      variant: {
        ...
        status: "border-electricCyan/40 bg-electricCyan/10 text-electricCyan hover:bg-electricCyan/20 hover:shadow-[0_0_8px_rgba(6,182,212,0.3)]",
        ...
        purple: "border-infinite-purple/30 bg-infinite-purple/10 text-infinite-purple hover:bg-infinite-purple/20 hover:shadow-[0_0_8px_rgba(107,70,193,0.3)]",
