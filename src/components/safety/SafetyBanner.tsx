...
export const SafetyBanner: React.FC<SafetyBannerProps> = ({
  ...
  const getComfortLevelColor = (level: string): string => {
    switch (level) {
      case 'pg': return 'bg-green-500/20 border-green-500 text-green-700';
      case 'pg13': return 'bg-yellow-500/20 border-yellow-500 text-yellow-700';
      case 'r': return 'bg-orange-500/20 border-orange-500 text-orange-700';
      case 'custom': return 'bg-purple-500/20 border-purple-500 text-purple-700';
      default: return 'bg-blue-500/20 border-blue-500 text-blue-700';
    }
  };
        ...
        <div className="p-3 flex items-center gap-3">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              <span className={`text-xs font-medium px-2 py-1 rounded-full border ${getComfortLevelColor(comfortLevel)}`}>
