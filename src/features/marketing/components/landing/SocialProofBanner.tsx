      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-gray-800/50 rounded-lg border border-gray-700/50 backdrop-blur-sm hover:border-purple-500/30 transition-all">
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                <path d="M13.3 22.06c-.5.3-1.1-.1-1.1-.6V12l8.5 9.7c.4.4.1 1.1-.5 1.1l-6.9.26zm-2.6 0c.5.3 1.1-.1 1.1-.6V12L3.3 21.7c-.4.4-.1 1.1.5 1.1l6.9.26zM12 2L3 10h18L12 2z" fill="#3ECF8E"/>
              </svg>
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-gray-800/50 rounded-lg border border-gray-700/50 backdrop-blur-sm hover:border-purple-500/30 transition-all">
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M8 10v4M12 8v8M16 10v4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="text-purple-400"/>
              </svg>
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-400 text-sm">
            ...
            <span className="text-purple-400 font-semibold">47 countries</span>
            {' '}and growing
          </p>
        </div>
      </div>
