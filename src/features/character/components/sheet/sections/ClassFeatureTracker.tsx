    ...
    <div className="space-y-6">
                ...
                {feature.maxUses !== undefined && feature.currentUses !== undefined && (
                  <div className="mt-2">
                    <div className="flex justify-between text-xs mb-1">
                      ...
                      <span>{feature.currentUses} / {feature.maxUses}</span>
                    </div>
                    <Progress 
      ...
      {characterResources && (
        <Card>
          ...
          <CardContent className="space-y-4">
            {/* Hit Dice */}
            {characterResources.hitDice && Object.entries(characterResources.hitDice).map(([dieType, dice]) => (
              <div key={dieType} className="border-l-4 border-yellow-500 pl-4">
                ...
                <div className="mt-2">
                  <div className="flex justify-between text-xs mb-1">
                    <span>Remaining</span>
                    <span>{dice.current} / {dice.max}</span>
                  </div>
                  <Progress 
            ...
            {characterResources.rages !== undefined && (
              <div className="border-l-4 border-red-500 pl-4">
                ...
                <div className="mt-2">
                  <div className="flex justify-between text-xs mb-1">
                    <span>Remaining</span>
                    <span>{characterResources.rages.current} / {characterResources.rages.max}</span>
                  </div>
                  <Progress 
            ...
            {characterResources.kiPoints !== undefined && (
              <div className="border-l-4 border-purple-500 pl-4">
                ...
                <div className="mt-2">
                  <div className="flex justify-between text-xs mb-1">
                    <span>Remaining</span>
                    <span>{characterResources.kiPoints.current} / {characterResources.kiPoints.max}</span>
                  </div>
                  <Progress 
                    value={(characterResources.kiPoints.current / characterResources.kiPoints.max) * 100} 
                    className="h-2"
                  />
                </div>
              </div>
            ...
            {characterResources.sorceryPoints !== undefined && (
              <div className="border-l-4 border-green-500 pl-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Badge 
                    variant={characterResources.sorceryPoints.current === 0 ? "destructive" : "outline"}
                    className="ml-auto"
                  >
                    {characterResources.sorceryPoints.current} / {characterResources.sorceryPoints.max}
                  </Badge>
                </div>
                <div className="mt-2">
                  <div className="flex justify-between text-xs mb-1">
                    <span>Remaining</span>
                    <span>{characterResources.sorceryPoints.current} / {characterResources.sorceryPoints.max}</span>
                  </div>
                  <Progress 
                    value={(characterResources.sorceryPoints.current / characterResources.sorceryPoints.max) * 100} 
                    className="h-2"
                  />
                </div>
              </div>
            ...
            {characterResources.bardic_inspiration !== undefined && (
              <div className="border-l-4 border-pink-500 pl-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Badge 
                    variant={characterResources.bardic_inspiration.current === 0 ? "destructive" : "outline"}
                    className="ml-auto"
                  >
                    {characterResources.bardic_inspiration.current} / {characterResources.bardic_inspiration.max}
                  </Badge>
                </div>
                <div className="mt-2">
                  <div className="flex justify-between text-xs mb-1">
                    <span>Remaining</span>
                    <span>{characterResources.bardic_inspiration.current} / {characterResources.bardic_inspiration.max}</span>
                  </div>
                  <Progress 
                    value={(characterResources.bardic_inspiration.current / characterResources.bardic_inspiration.max) * 100} 
                    className="h-2"
                  />
                </div>
              </div>
            ...
            {characterResources.channelDivinity !== undefined && (
              <div className="border-l-4 border-indigo-500 pl-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Badge 
                    variant={characterResources.channelDivinity.current === 0 ? "destructive" : "outline"}
                    className="ml-auto"
                  >
                    {characterResources.channelDivinity.current} / {characterResources.channelDivinity.max}
                  </Badge>
                </div>
                <div className="mt-2">
                  <div className="flex justify-between text-xs mb-1">
                    <span>Remaining</span>
                    <span>{characterResources.channelDivinity.current} / {characterResources.channelDivinity.max}</span>
                  </div>
                  <Progress 
                    value={(characterResources.channelDivinity.current / characterResources.channelDivinity.max) * 100} 
                    className="h-2"
                  />
                </div>
              </div>
              ...
              <div className="border-l-4 border-orange-500 pl-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Badge 
                    ...
                    className="ml-auto"
                  >
                    {characterResources.layOnHands.current} / {characterResources.layOnHands.max} points
                  </Badge>
                </div>
                <div className="mt-2">
                  <div className="flex justify-between text-xs mb-1">
                    <span>Remaining</span>
                    <span>{characterResources.layOnHands.current} / {characterResources.layOnHands.max}</span>
                  </div>
                  <Progress 
                    value={(characterResources.layOnHands.current / characterResources.layOnHands.max) * 100} 
                    className="h-2"
                  />
                </div>
              </div>
            ...
            {characterResources.actionSurge !== undefined && (
              <div className="border-l-4 border-cyan-500 pl-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Badge 
                    variant={characterResources.actionSurge.current === 0 ? "destructive" : "outline"}
                    className="ml-auto"
                  >
                ...
                <div className="mt-2">
                  <div className="flex justify-between text-xs mb-1">
                    <span>Remaining</span>
                    <span>{characterResources.actionSurge.current} / {characterResources.actionSurge.max}</span>
                  </div>
                  <Progress 
                    value={(characterResources.actionSurge.current / characterResources.actionSurge.max) * 100} 
                    className="h-2"
                  />
                </div>
              </div>
