        ...
        >
          ...
          return (
            ...
            >
              ...
              <div className={`absolute bottom-3 left-3 z-10 flex items-center gap-2 ${isSelected ? 'text-white' : 'text-white'}`}>
                {genre.icon}
                <span className="font-bold text-lg drop-shadow">{genre.label}</span>
              </div>

              <div className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 ${hovered === genre.value ? 'opacity-100 scale-100' : 'opacity-0 scale-95'} z-20`}>
