...
const campaignTheme = {
  ...
  stepPreviewCard: 'p-4 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 dark:from-blue-950/20 dark:to-indigo-950/20 border-blue-200 dark:border-blue-800',
...
const renderCampaignStepIcon = (stepIndex: number, isCompleted: boolean, isCurrent: boolean) => {
  ...
  if (isCurrent) {
    ...
    switch (stepIndex) {
      case 0: return <Wand2 className="w-4 h-4 text-blue-600" />;
      case 1: return <Map className="w-4 h-4 text-blue-600" />;
      case 2: return <Settings className="w-4 h-4 text-blue-600" />;
      case 3: return <Sparkles className="w-4 h-4 text-blue-600" />;
      default: return <Circle className="w-4 h-4 text-blue-600 fill-blue-600" />;
    }
  }
