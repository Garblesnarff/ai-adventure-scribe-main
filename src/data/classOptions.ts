...
export const classes: CharacterClass[] = [
  {
    ...
    backgroundImage: '/fighter-class-card-background.png',
    hitDie: 10,
  ...
  },
  {
    ...
    backgroundImage: '/wizard-class-card-background.png',
    hitDie: 6,
  ...
  },
  {
    ...
    backgroundImage: '/rogue-class-card-background.png',
    hitDie: 8,
  ...
  },
  {
    ...
    backgroundImage: '/cleric-class-card-background.png',
    hitDie: 8,
  ...
  },
  {
    ...
    backgroundImage: '/bard-class-card-background.png',
    hitDie: 8,
  ...
  },
  {
    ...
    backgroundImage: '/barbarian-class-card-background.png',
    hitDie: 12,
    primaryAbility: 'strength' as keyof AbilityScores,
    savingThrowProficiencies: ['strength', 'constitution'] as (keyof AbilityScores)[],
    ...
    classFeatures: [
      {
        id: 'rage',
        name: 'Rage',
        description: 'In battle, you fight with primal ferocity. On your turn, you can enter a rage as a bonus action. While raging, you gain advantage on Strength checks and Strength saving throws, +2 damage to melee attacks using Strength, and resistance to bludgeoning, piercing, and slashing damage. You can rage once per long rest.'
      },
      {
  ...
  },
  {
    ...
    backgroundImage: '/druid-class-card-background.png',
    hitDie: 8,
    primaryAbility: 'wisdom' as keyof AbilityScores,
    savingThrowProficiencies: ['intelligence', 'wisdom'] as (keyof AbilityScores)[],
    ...
    classFeatures: [
      {
        id: 'druidcraft',
        name: 'Druidcraft',
        description: 'You know the druidcraft cantrip. It doesn\'t count against your number of cantrips known.'
      },
      {
        id: 'spellcasting',
        name: 'Spellcasting',
  ...
  },
  {
    id: 'monk',
    name: 'Monk',
    description: 'A master of martial arts, harnessing inner power and achieving physical perfection.',
    backgroundImage: '/monk-class-card-background.png',
    hitDie: 8,
    primaryAbility: 'dexterity' as keyof AbilityScores,
  ...
  },
  {
    ...
    backgroundImage: '/paladin-class-card-background.png',
    hitDie: 10,
    primaryAbility: 'strength' as keyof AbilityScores,
    savingThrowProficiencies: ['wisdom', 'charisma'] as (keyof AbilityScores)[],
    ...
    classFeatures: [
      {
        id: 'divine-sense',
        name: 'Divine Sense',
        description: 'You can use your action to detect good and evil. Until the end of your next turn, you know the location of any celestial, fiend, or undead within 60 feet that is not behind total cover. You can use this feature once per long rest.'
      },
      {
        id: 'lay-on-hands',
        name: 'Lay on Hands',
        description: 'You have a pool of healing power that replenishes when you take a long rest. With that pool, you can restore a total number of hit points equal to your paladin level × 5. As an action, you can touch a creature and draw power from the pool to restore hit points to that creature.'
      }
    ]
  },
  {
    ...
    backgroundImage: '/ranger-class-card-background.png',
    hitDie: 10,
    primaryAbility: 'dexterity' as keyof AbilityScores,
    savingThrowProficiencies: ['strength', 'dexterity'] as (keyof AbilityScores)[],
    ...
    classFeatures: [
      {
        id: 'favored-enemy',
        name: 'Favored Enemy',
        description: 'Choose a type of favored enemy: beasts, fey, humanoids, monstrosities, or undead. You have advantage on Wisdom (Survival) checks to track your favored enemies, as well as on Intelligence checks to recall information about them.',
        choices: {
          name: 'Favored Enemy',
          options: [
          ...
          description: 'Choose the type of creature you have studied and learned to hunt effectively.'
        }
      },
      {
        id: 'natural-explorer',
        name: 'Natural Explorer',
        description: 'Choose a favored terrain: forest, mountains, swamp, coast, desert, grassland, or underdark. When you make a Wisdom (Survival) check in your favored terrain, your proficiency bonus is doubled.',
        choices: {
  ...
  },
  {
    ...
    backgroundImage: '/sorcerer-class-card-background.png',
    hitDie: 6,
    primaryAbility: 'charisma' as keyof AbilityScores,
  ...
  },
  {
    ...
    backgroundImage: '/warlock-class-card-background.png',
    hitDie: 8,
    primaryAbility: 'charisma' as keyof AbilityScores,
    savingThrowProficiencies: ['wisdom', 'charisma'] as (keyof AbilityScores)[],
