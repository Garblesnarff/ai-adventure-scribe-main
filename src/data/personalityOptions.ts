...
export const inspirationTriggers: InspirationTrigger[] = [
  {
    ...
    description: 'Character acts in a way that clearly demonstrates their personality trait, even when it complicates the situation.',
    example: 'A character with the trait "I speak without thinking" blurts out sensitive information at an inopportune moment.',
    personalityType: 'trait'
  },
  {
    id: 'pursue-ideal',
    name: 'Pursuing Ideals',
    description: 'Character makes a significant choice or takes action that clearly demonstrates their ideals.',
    example: 'A character with the ideal "Freedom" helps enslaved people escape, even at personal risk.',
    personalityType: 'ideal'
  },
  {
    id: 'protect-bond',
    name: 'Protecting Bonds',
    description: 'Character goes out of their way to protect, help, or honor something or someone they are bonded to.',
  ...
  },
  {
    ...
    example: 'A character with "I can\'t resist a pretty face" turns down a seductive but dangerous offer.',
    personalityType: 'flaw'
  },
  {
    id: 'flaw-creates-trouble',
    name: 'Flaw Creates Interesting Trouble',
    description: 'Character\'s flaw creates complications that enhance the story in an entertaining way.',
    example: 'A greedy character\'s attempt to steal something valuable leads the party into unexpected adventure.',
    personalityType: 'flaw'
  },
  {
    ...
    example: 'A character\'s bond to their missing sister drives them to investigate mysterious disappearances.',
    personalityType: 'bond'
  }
];
...
export const personalityGuidance = {
  traits: {
    description: 'Personality traits give your character a distinctive behavior pattern or mannerism.',
    examples: [
  ...
  bonds: {
    description: 'Bonds connect your character to the world, representing people, places, or things important to them.',
    examples: [
  ...
  flaws: {
    description: 'Flaws represent your character\'s weaknesses, compulsions, or negative personality aspects.',
    examples: [
 ...
 */
export function getRandomPersonalityExamples(category: PersonalityExample['category'], count: number = 3): PersonalityExample[] {
...
export function getPersonalityExamplesByBackground(backgroundId: string): {
  ...
  const backgroundExamples = personalityExamples.filter(example => 
 ...
 */
export function getInspirationTriggersByType(personalityType: InspirationTrigger['personalityType']): InspirationTrigger[] {
  return inspirationTriggers.filter(trigger => 
    trigger.personalityType === personalityType || trigger.personalityType === 'trait'
  );
}