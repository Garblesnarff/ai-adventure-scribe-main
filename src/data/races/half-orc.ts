...
const heightRange: [number, number] = ranges ? [...ranges.heightRange] as [number, number] : [60, 78];
const weightRange: [number, number] = ranges ? [...ranges.weightRange] as [number, number] : [144, 380];
