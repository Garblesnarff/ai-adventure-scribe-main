 ...
 */
export const multiclassRequirements: Record<string, { ability: keyof AbilityScores; minimum: number }> = {
...
export const classProgressions: Record<string, LevelFeature[]> = {
  fighter: [
    ...
    { level: 2, featureName: 'Action Surge', description: 'Take an additional action on your turn.' },
    { level: 3, featureName: 'Martial Archetype', description: 'Choose your martial archetype.' },
    { level: 4, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true },
    { level: 5, featureName: 'Extra Attack', description: 'Attack twice when you take the Attack action.' },
    { level: 6, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true },
    { level: 7, featureName: 'Martial Archetype Feature', description: 'Gain a feature from your chosen archetype.' },
    { level: 8, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true },
    { level: 9, featureName: 'Indomitable', description: 'Reroll a failed saving throw.' },
    { level: 10, featureName: 'Martial Archetype Feature', description: 'Gain a feature from your chosen archetype.' },
    { level: 11, featureName: 'Extra Attack (2)', description: 'Attack three times when you take the Attack action.' },
    { level: 12, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true }
  ],
  
  wizard: [
    { level: 1, featureName: 'Spellcasting', description: 'Cast wizard spells.' },
    { level: 1, featureName: 'Arcane Recovery', description: 'Recover spell slots on a short rest.' },
    ...
    { level: 6, featureName: 'Arcane Tradition Feature', description: 'Gain a feature from your chosen tradition.' },
    ...
    { level: 10, featureName: 'Arcane Tradition Feature', description: 'Gain a feature from your chosen tradition.' },
  ...
  rogue: [
    ...
    { level: 1, featureName: 'Sneak Attack', description: 'Deal extra damage when you have advantage.' },
    { level: 1, featureName: 'Thieves\' Cant', description: 'Secret language of rogues.' },
    { level: 2, featureName: 'Cunning Action', description: 'Dash, Disengage, or Hide as bonus actions.' },
    { level: 3, featureName: 'Roguish Archetype', description: 'Choose your roguish archetype.' },
    { level: 4, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true },
    { level: 5, featureName: 'Uncanny Dodge', description: 'Halve damage from one attack per turn.' },
    { level: 6, featureName: 'Expertise', description: 'Double proficiency bonus for two more skills.' },
    { level: 7, featureName: 'Evasion', description: 'Take no damage on successful Dex saves.' },
    { level: 8, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true },
    { level: 9, featureName: 'Roguish Archetype Feature', description: 'Gain a feature from your chosen archetype.' },
    { level: 10, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true },
    { level: 11, featureName: 'Reliable Talent', description: 'Treat d20 rolls of 9 or lower as 10 for skills.' },
    { level: 12, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true }
  ],
  ...
  cleric: [
    ...
    { level: 2, featureName: 'Channel Divinity', description: 'Channel divine energy for magical effects.' },
    { level: 3, featureName: '2nd-level Spells', description: 'Cast 2nd-level spells.' },
    { level: 4, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true },
    { level: 5, featureName: 'Destroy Undead', description: 'Destroy undead with Channel Divinity.' },
    { level: 5, featureName: '3rd-level Spells', description: 'Cast 3rd-level spells.' },
    { level: 6, featureName: 'Channel Divinity (2/rest)', description: 'Use Channel Divinity twice per rest.' },
    { level: 6, featureName: 'Divine Domain Feature', description: 'Gain a feature from your divine domain.' },
    { level: 7, featureName: '4th-level Spells', description: 'Cast 4th-level spells.' },
    { level: 8, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true },
    { level: 8, featureName: 'Divine Domain Feature', description: 'Gain a feature from your divine domain.' },
    ...
    { level: 11, featureName: 'Destroy Undead (CR 2)', description: 'Destroy more powerful undead.' },
    { level: 12, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true }
  ],

  barbarian: [
    { level: 1, featureName: 'Rage', description: 'Enter a battle rage for bonus damage and resistance.' },
    { level: 1, featureName: 'Unarmored Defense', description: 'AC = 10 + Dex mod + Con mod when unarmored.' },
    { level: 2, featureName: 'Reckless Attack', description: 'Gain advantage on attacks but enemies have advantage on you.' },
    { level: 2, featureName: 'Danger Sense', description: 'Advantage on Dex saves against effects you can see.' },
    { level: 3, featureName: 'Primal Path', description: 'Choose your primal path.' },
    { level: 4, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true },
    { level: 5, featureName: 'Extra Attack', description: 'Attack twice when you take the Attack action.' },
    { level: 5, featureName: 'Fast Movement', description: 'Speed increases by 10 feet when not wearing heavy armor.' },
    { level: 6, featureName: 'Primal Path Feature', description: 'Gain a feature from your primal path.' },
    { level: 7, featureName: 'Feral Instinct', description: 'Advantage on initiative and can\'t be surprised while conscious.' },
    { level: 8, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true },
    { level: 9, featureName: 'Brutal Critical (1 die)', description: 'Roll one additional damage die on critical hits.' },
    { level: 10, featureName: 'Primal Path Feature', description: 'Gain a feature from your primal path.' },
    { level: 11, featureName: 'Relentless Rage', description: 'Keep fighting when you drop to 0 hit points.' },
    { level: 12, featureName: 'Ability Score Improvement', description: 'Improve ability scores or take a feat.', abilityScoreImprovement: true }
  ]
};
 ...
 */
export const multiclassProficiencies: Record<string, {
  armor?: string[];
  weapons?: string[];
  tools?: string[];
  skillChoices?: string[];
