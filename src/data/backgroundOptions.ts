...
export const backgrounds: CharacterBackground[] = [
  ...
  },
  {
    id: 'hermit',
    name: 'Hermit',
    description: 'You lived in seclusion for a formative part of your life, finding quiet contemplation and perhaps the answers you sought.',
  ...
  },
  {
    id: 'entertainer',
    name: 'Entertainer',
    description: 'You thrive in front of an audience, knowing how to entrance them, entertain them, and even inspire them.',
