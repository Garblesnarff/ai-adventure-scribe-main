...
describe('Racial Spell Integration Edge Cases', () => {
  ...
  describe('Forest Gnome Racial Magic', () => {
    it('should allow Forest Gnome Fighter to have Minor Illusion', () => {
      const forestGnomeFighter = createMockCharacter('Forest Gnome Fighter', mockFighter, mockHuman, mockForestGnomeSubrace);
    ...
    it('should allow Forest Gnome Wizard to include racial cantrip', () => {
      const forestGnomeWizard = createMockCharacter('Forest Gnome Wizard', mockWizard, mockHuman, mockForestGnomeSubrace);
  ...
  describe('Complex Racial Combinations', () => {
    it('should handle character with multiple racial spell sources', () => {
      ...
      const complexCharacter = createMockCharacter('Complex Elf', mockWizard, mockElf, complexSubrace);
    ...
    it('should handle edge case where racial spell overlaps with class spell', () => {
      ...
      const tieflingCleric = createMockCharacter('Tiefling Cleric', mockCleric, mockHuman, mockTieflingSubrace);
  ...
  describe('Racial Spell Validation Edge Cases', () => {
    ...
    it('should handle corrupted racial data', () => {
      ...
      const corruptedCharacter = createMockCharacter('Corrupted', mockWizard, mockElf, corruptedSubrace);
    ...
    it('should prioritize subrace data over hardcoded mapping', () => {
      ...
      const modernCharacter = createMockCharacter('Modern High Elf', mockFighter, mockElf, modernHighElf);
    ...
    it('should fall back to hardcoded mapping when subrace data is incomplete', () => {
      ...
      const incompleteCharacter = createMockCharacter('Incomplete', mockFighter, mockElf, incompleteSubrace);
  ...
  describe('Performance and Security', () => {
    it('should handle large numbers of racial spells efficiently', () => {
      const manySpellsSubrace = {
        ...
        abilityScoreIncrease: {},
        traits: [],
        cantrips: Array(50).fill(0).map((_, i) => `test-cantrip-${i}`),
        spells: Array(100).fill(0).map((_, i) => `test-spell-${i}`)
      };

      const manySpellsCharacter = createMockCharacter('Many Spells', mockWizard, mockElf, manySpellsSubrace);
    ...
    it('should prevent racial spell injection attacks', () => {
      ...
      const maliciousCharacter = createMockCharacter('Malicious', mockWizard, mockElf, maliciousSubrace);
