...
import { FightingStyle, FightingStyleName, CombatParticipant, WeaponProperties } from '@/types/combat';
...
export const FIGHTING_STYLES: Record<FightingStyleName, FightingStyle> = {
  ...
  two_weapon_fighting: {
    ...
    description: 'When you fight with two weapons, you can add your ability modifier to the damage of the second attack.',
    effect: {
