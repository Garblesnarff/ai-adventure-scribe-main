...
export class SentenceSegmenter {
  ...
  private static readonly ABBREVIATIONS = new Set([
    'dr', 'mr', 'mrs', 'ms', 'prof', 'st', 'ave', 'blvd', 'etc', 'vs', 'jr', 'sr',
    'inc', 'ltd', 'corp', 'co', 'dept', 'govt', 'min', 'max', 'approx', 'est',
    'ft', 'in', 'yd', 'mi', 'lb', 'oz', 'pt', 'qt', 'gal', 'mph', 'rpm',
    'no', 'nos', 'fig', 'figs', 'vol', 'vols', 'ch', 'chs', 'pg', 'pgs',
    'ref', 'refs', 'ed', 'eds', 'rev', 'revs', 'jan', 'feb', 'mar', 'apr',
   ...
   */
  private static isSentenceEnd(currentSentence: string, nextChar: string, followingChar: string): boolean {
   ...
   */
  static splitLongSegmentAtClauses(segment: string, minLength: number = 20, maxLength: number = 200): string[] {
   ...
   */
  static optimizeSegmentLengths(segments: string[], minLength: number = 20, maxLength: number = 200): string[] {
