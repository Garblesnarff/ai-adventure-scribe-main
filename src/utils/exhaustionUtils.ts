...
import { ExhaustionEffect, Condition, CombatParticipant } from '@/types/combat';
 ...
 */
export function getActiveExhaustionEffects(participant: CombatParticipant): ExhaustionEffect | null {
  const level = getExhaustionLevel(participant.conditions);
