...
export class CampaignImageGenerator {
  ...
  private getGenrePrompt(genre: string): string {
    const genreMap: Record<string, string> = {
      'high-fantasy': 'Majestic medieval fantasy realm with castles, dragons, magical elements, enchanted forests.',
      'dark-fantasy': 'Gothic dark fantasy landscape with ominous skies, twisted trees, mysterious ruins, shadowy atmosphere.',
      'urban-fantasy': 'Modern city with magical elements, supernatural creatures, mystical energy flowing through urban environment.',
      'steampunk': 'Victorian-era landscape with brass machinery, airships, steam-powered technology, clockwork elements.',
      'cyberpunk': 'Futuristic neon-lit cityscape with holographic displays, cyber-enhanced architecture, digital rain effects.',
      'post-apocalyptic': 'Desolate wasteland with crumbling ruins, overgrown vegetation, abandoned structures, harsh lighting.',
      'space-opera': 'Epic space scene with distant planets, nebulae, starships, cosmic phenomena, alien architecture.',
      'horror': 'Eerie landscape with unsettling atmosphere, haunted locations, supernatural elements, foreboding mood.',
      'mystery': 'Atmospheric scene with hidden secrets, fog-shrouded environments, mysterious locations, investigation mood.',
      'adventure': 'Exciting landscape with exploration elements, hidden treasures, dangerous terrain, adventure spirit.',
    };
  ...
  private getLocationPrompt(location?: string | null, era?: string | null): string | null {
    ...
    if (location) {
      const locationMap: Record<string, string> = {
        ...
        'mountains': 'Majestic mountain range with snow-capped peaks, dramatic cliffs, alpine landscapes.',
        'desert': 'Vast desert landscape with rolling sand dunes, oasis, ancient ruins, golden light.',
        'ocean': 'Endless ocean with dramatic waves, mysterious islands, sea creatures, maritime elements.',
        'city': 'Grand fantasy city with impressive architecture, bustling districts, magical lighting.',
        'underground': 'Underground cavern system with crystal formations, glowing minerals, subterranean beauty.',
        'plains': 'Rolling grasslands with windswept fields, distant horizons, pastoral beauty.',
        'swamp': 'Mysterious swampland with twisted trees, murky water, ethereal mist, haunting atmosphere.',
      };
    ...
    if (era) {
      const eraMap: Record<string, string> = {
        'medieval': 'Medieval period with castles, knights, ancient architecture, historical authenticity.',
        'renaissance': 'Renaissance era with elegant architecture, artistic elements, refined aesthetics.',
        'victorian': 'Victorian period with ornate designs, industrial elements, steampunk influence.',
        'modern': 'Contemporary setting with modern elements seamlessly blended with fantasy.',
        'futuristic': 'Advanced future technology integrated with magical elements, sci-fi fantasy fusion.',
        'ancient': 'Ancient civilization with ruins, mysterious artifacts, lost empire aesthetics.',
        'prehistoric': 'Primordial landscape with untamed wilderness, ancient creatures, raw natural power.',
      };
  ...
  private getDifficultyPrompt(difficulty: string): string {
    const difficultyMap: Record<string, string> = {
      ...
      'intermediate': 'Moderately challenging terrain with balanced light and shadow, adventure elements.',
      'advanced': 'Treacherous landscape with dangerous elements, dramatic lighting, challenging terrain.',
      'expert': 'Extremely hostile environment with perilous conditions, intense dramatic atmosphere.',
    };
