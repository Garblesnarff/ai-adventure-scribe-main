...
const spellProgressionTables: Record<string, SpellProgression[]> = {
  ...
  Warlock: [
    { character_level: 1, cantrips_known: 2, spells_known: 2, spell_slots_1: 1, spell_slots_2: 0, spell_slots_3: 0, spell_slots_4: 0, spell_slots_5: 0, spell_slots_6: 0, spell_slots_7: 0, spell_slots_8: 0, spell_slots_9: 0 },
    { character_level: 2, cantrips_known: 2, spells_known: 3, spell_slots_1: 2, spell_slots_2: 0, spell_slots_3: 0, spell_slots_4: 0, spell_slots_5: 0, spell_slots_6: 0, spell_slots_7: 0, spell_slots_8: 0, spell_slots_9: 0 }
  ],
  Bard: [
...
const spellcastingClasses: SpellcastingClass[] = [
  { id: 'wizard', name: 'Wizard', spellcasting_ability: 'Intelligence', caster_type: 'full', spell_slots_start_level: 1 },
  { id: 'sorcerer', name: 'Sorcerer', spellcasting_ability: 'Charisma', caster_type: 'full', spell_slots_start_level: 1 },
  { id: 'warlock', name: 'Warlock', spellcasting_ability: 'Charisma', caster_type: 'pact', spell_slots_start_level: 1 },
  { id: 'bard', name: 'Bard', spellcasting_ability: 'Charisma', caster_type: 'full', spell_slots_start_level: 1 },
  { id: 'cleric', name: 'Cleric', spellcasting_ability: 'Wisdom', caster_type: 'full', spell_slots_start_level: 1 },
  { id: 'druid', name: 'Druid', spellcasting_ability: 'Wisdom', caster_type: 'full', spell_slots_start_level: 1 }
];
...
class LocalSpellService {
  ...
  async getMulticlassSpellSlots(casterLevel: number): Promise<MulticlassSpellSlots> {
    ...
    const spellSlotTable: Record<number, MulticlassSpellSlots> = {
      1: { caster_level: 1, spell_slots_1: 2, spell_slots_2: 0, spell_slots_3: 0, spell_slots_4: 0, spell_slots_5: 0, spell_slots_6: 0, spell_slots_7: 0, spell_slots_8: 0, spell_slots_9: 0 },
      2: { caster_level: 2, spell_slots_1: 3, spell_slots_2: 0, spell_slots_3: 0, spell_slots_4: 0, spell_slots_5: 0, spell_slots_6: 0, spell_slots_7: 0, spell_slots_8: 0, spell_slots_9: 0 },
      3: { caster_level: 3, spell_slots_1: 4, spell_slots_2: 2, spell_slots_3: 0, spell_slots_4: 0, spell_slots_5: 0, spell_slots_6: 0, spell_slots_7: 0, spell_slots_8: 0, spell_slots_9: 0 },
      4: { caster_level: 4, spell_slots_1: 4, spell_slots_2: 3, spell_slots_3: 0, spell_slots_4: 0, spell_slots_5: 0, spell_slots_6: 0, spell_slots_7: 0, spell_slots_8: 0, spell_slots_9: 0 },
      5: { caster_level: 5, spell_slots_1: 4, spell_slots_2: 3, spell_slots_3: 2, spell_slots_4: 0, spell_slots_5: 0, spell_slots_6: 0, spell_slots_7: 0, spell_slots_8: 0, spell_slots_9: 0 }
    };
    ...
    classLevels.forEach(({ className, level }) => {
      ...
      if (spellcastingClass) {
        if (spellcastingClass.caster_type === 'full') {
          ...
          pactMagicSlots = { level: Math.min(5, Math.ceil(level / 2)), slots: level < 2 ? 1 : level < 11 ? 2 : level < 17 ? 3 : 4 };
        }
      }
    });

    const spellSlots = totalCasterLevel > 0 ? await this.getMulticlassSpellSlots(totalCasterLevel) : null;
