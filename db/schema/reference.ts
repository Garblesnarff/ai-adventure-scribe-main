...
export type NewRace = InferInsertModel<typeof races>;

export type Spell = InferSelectModel<typeof spells>;
export type NewSpell = InferInsertModel<typeof spells>;

export type ClassSpell = InferSelectModel<typeof classSpells>;
export type NewClassSpell = InferInsertModel<typeof classSpells>;

export type CharacterSpell = InferSelectModel<typeof characterSpells>;
export type NewCharacterSpell = InferInsertModel<typeof characterSpells>;
